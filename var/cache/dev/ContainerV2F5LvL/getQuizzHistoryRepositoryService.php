...
class getQuizzHistoryRepositoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'QuizzHistoryRepository.php';

        return $container->privates['App\\Repository\\QuizzHistoryRepository'] = new \App\Repository\QuizzHistoryRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
