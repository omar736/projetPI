...
class __TwigTemplate_6cd0926c3a6697ae9a6200016691a9167c4e2c38e606cefb6afe5d96e4bbdd64 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"row\">
        <div class=\"col-6 offset-3\">
            ...
            <div class=\"card bg-light\">
                <div class=\"card-body\">
                    ...
                    <h1 class=\"text-center\">Modifier son profil</h1>
                    <br><br>
                    <a href=\"/profile/";
        // line 15
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 15, $this->source); })()), "user", [], "any", false, false, false, 15), "id", [], "any", false, false, false, 15), "html", null, true);
        echo "/editMail\">Modifier son adresse email</a>
                    <br><br>
                    <a href=\"/profile/";
        // line 17
        ...
        echo "/editPassword\">Modifier son mot de passe</a>
                    <br>
        ...
        <div class=\"col-6 offset-3\">
            ...
            <div class=\"card bg-light\">
                <div class=\"card-body\">
                    ...
                    <h1 class=\"text-center\">Modifier son profil</h1>
                    <br><br>
                    <a href=\"/profile/{{ app.user.id }}/editMail\">Modifier son adresse email</a>
                    <br><br>
                    <a href=\"/profile/{{ app.user.id }}/editPassword\">Modifier son mot de passe</a>
                    <br>
...
{% endblock %}
", "profile/index.html.twig", "C:\\Users\\oumai\\OneDrive\\Bureau\\quizz\\templates\\profile\\index.html.twig");
    }
}
