...
class __TwigTemplate_7a86b3a5c76b591ca3e8108849aecce7bb14120cb974a767789a10749c8795ed extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["question"]) {
            ...
            echo "</td>
                <td>";
            // line 22
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["question"], "categorie", [], "any", false, false, false, 22), "html", null, true);
            echo "</td>
                <td>";
            // line 23
            ...
            echo "</td>
                <td>
                    <a href=\"";
            // line 25
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("question_show", ["id" => twig_get_attribute($this->env, $this->source, $context["question"], "id", [], "any", false, false, false, 25)]), "html", null, true);
            echo "\">Voir</a>
                    <a href=\"";
            // line 26
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("question_edit", ["id" => twig_get_attribute($this->env, $this->source, $context["question"], "id", [], "any", false, false, false, 26)]), "html", null, true);
            echo "\">Modifier</a>
                </td>
            </tr>
        ";
...
{% block body %}
    ...
    <table class=\"table\">
        ...
        {% for question in questions %}
            <tr>
                ...
                <td>
                    <a href=\"{{ path('question_show', {'id': question.id}) }}\">Voir</a>
    ...
    <a href=\"{{ path('question_new') }}\">Ajouter</a>
{% endblock %}
", "question/index.html.twig", "C:\\Users\\oumai\\OneDrive\\Bureau\\quizz\\templates\\question\\index.html.twig");
    }
}
