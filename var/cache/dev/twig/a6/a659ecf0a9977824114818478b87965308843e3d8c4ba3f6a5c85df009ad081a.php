...
/* user/show.html.twig */
class __TwigTemplate_1f61b40f01758917822b772d1b14974c0a27f2f001f666762974cd21098aef2c extends Template
{
    private $source;
    private $macros = [];
    ...
    <a href=\"";
        // line 37
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("user_edit", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 37, $this->source); })()), "id", [], "any", false, false, false, 37)]), "html", null, true);
        echo "\">Modifier</a>
...
{% endblock %}
", "user/show.html.twig", "C:\\Users\\aea\\Desktop\\Quizz_PHP_SYMFONY-master\\templates\\user\\show.html.twig");
    }
}
