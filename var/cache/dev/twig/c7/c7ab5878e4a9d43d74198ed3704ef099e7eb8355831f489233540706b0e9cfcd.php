...
class __TwigTemplate_8acdc9a787657da0d6e442b76d6ebf3d280840f84df2f0241ed289b2d9d4afd7 extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["reponse"]) {
            ...
            echo "</td>
                <td>";
            // line 23
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["reponse"], "question", [], "any", false, false, false, 23), "html", null, true);
            echo "</td>
                <td>";
            // line 24
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["reponse"], "reponse", [], "any", false, false, false, 24), "html", null, true);
            echo "</td>
                <td>";
            // line 25
            echo ((twig_get_attribute($this->env, $this->source, $context["reponse"], "reponseExpected", [], "any", false, false, false, 25)) ? ("Yes") : ("No"));
            echo "</td>
                <td>
                    <a href=\"";
            // line 27
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("reponse_show", ["id" => twig_get_attribute($this->env, $this->source, $context["reponse"], "id", [], "any", false, false, false, 27)]), "html", null, true);
            echo "\">Voir</a>
                    <a href=\"";
            // line 28
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("reponse_edit", ["id" => twig_get_attribute($this->env, $this->source, $context["reponse"], "id", [], "any", false, false, false, 28)]), "html", null, true);
            echo "\">Modifier</a>
                </td>
            </tr>
        ";
...
{% block title %}Index Réponse{% endblock %}
...
{% block body %}
    ...
    <table class=\"table\">
        ...
        {% for reponse in reponses %}
            <tr>
                ...
                <td>
                    <a href=\"{{ path('reponse_show', {'id': reponse.id}) }}\">Voir</a>
    ...
    <a href=\"{{ path('reponse_new') }}\">Ajouter</a>
{% endblock %}
", "reponse/index.html.twig", "C:\\Users\\aea\\Desktop\\Quizz_PHP_SYMFONY-master\\templates\\reponse\\index.html.twig");
    }
}
