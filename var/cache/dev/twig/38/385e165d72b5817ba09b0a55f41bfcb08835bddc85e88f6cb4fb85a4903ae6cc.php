...
class __TwigTemplate_f68dae60fb544bb89a0060fab5bbfd418bf140672870a8437d9f052ebdaae342 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        // line 2
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock((isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 2, $this->source); })()), 'widget', ["attr" => ["class" => "blabla"]]);
        echo "
...
";
    ...
    {{ form_widget(form, { 'attr': { 'class': 'blabla' } }) }}
    <button class=\"btn btn-primary\">{{ button_label|default('Enregistrer') }}</button>
{{ form_end(form) }}
", "user/_form.html.twig", "C:\\Users\\aea\\Desktop\\Quizz_PHP_SYMFONY-master\\templates\\user\\_form.html.twig");
    }
}
