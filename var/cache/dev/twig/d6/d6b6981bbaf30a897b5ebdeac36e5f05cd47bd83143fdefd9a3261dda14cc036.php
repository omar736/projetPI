...
class __TwigTemplate_a789e831c8e7bdb7ac240b34f6afeecc2c41d8ff4a2468c7b817c2c31c983d8e extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"row\">
        ...
        echo "
                        ";
        // line 19
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["registrationForm"]) || array_key_exists("registrationForm", $context) ? $context["registrationForm"] : (function () { throw new RuntimeError('Variable "registrationForm" does not exist.', 19, $this->source); })()), "plainPassword", [], "any", false, false, false, 19), 'row', ["label" => "Mot de passe"]);
        // line 21
        echo "
                        ";
        // line 22
...
";
    ...
    {
        return array (  131 => 25,  125 => 22,  122 => 21,  120 => 19,  116 => 18,  112 => 17,  102 => 9,  93 => 7,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% endblock %}
", "registration/register.html.twig", "C:\\Users\\oumai\\OneDrive\\Bureau\\quizz\\templates\\registration\\register.html.twig");
    }
}
