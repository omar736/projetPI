...
class __TwigTemplate_ba874b615b9371ee57446b839f44ddb9903ea67fe729ec83f51cd96952d3e17d extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        // line 10
        echo twig_include($this->env, $context, "categorie/_form.html.twig", ["button_label" => "Sauvegarder"]);
        echo "
...
{% block body %}
    ...
    {{ include('categorie/_form.html.twig', {'button_label': 'Sauvegarder'}) }}
    
    {{ include('categorie/_delete_form.html.twig') }}
    <br>
    <a href=\"{{ path('categorie_index') }}\">Retour</a>
{% endblock %}
", "categorie/edit.html.twig", "C:\\Users\\aea\\Desktop\\Quizz_PHP_SYMFONY-master\\templates\\categorie\\edit.html.twig");
    }
}
