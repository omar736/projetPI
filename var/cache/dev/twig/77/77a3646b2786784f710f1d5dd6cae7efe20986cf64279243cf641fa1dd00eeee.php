...
class __TwigTemplate_18eb38a4b355fc7e2a0db4b734f39aa69e58fc82b803b0e5d42d1eb16d99c74f extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        echo "</td>
            ...
            <tr>
                ...
                <td>";
        // line 18
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["question"]) || array_key_exists("question", $context) ? $context["question"] : (function () { throw new RuntimeError('Variable "question" does not exist.', 18, $this->source); })()), "categorie", [], "any", false, false, false, 18), "html", null, true);
        echo "</td>
            </tr>
            <tr>
                <th>Question</th>
                <td>";
        // line 22
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["question"]) || array_key_exists("question", $context) ? $context["question"] : (function () { throw new RuntimeError('Variable "question" does not exist.', 22, $this->source); })()), "question", [], "any", false, false, false, 22), "html", null, true);
        echo "</td>
            </tr>
        </tbody>
    </table>
...
{% block body %}
    ...
    <a href=\"{{ path('question_index') }}\">Retour</a>

    <a href=\"{{ path('question_edit', {'id': question.id}) }}\">Modifier</a>

    {{ include('question/_delete_form.html.twig') }}
{% endblock %}
", "question/show.html.twig", "C:\\Users\\oumai\\OneDrive\\Bureau\\quizz\\templates\\question\\show.html.twig");
    }
}
